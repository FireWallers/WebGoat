...
namespace WebGoatCore.DomainModels
{
    public class OrderDM
    {
        ...
        public virtual IList<OrderDetailDM> OrderDetails { get; set; }
        public virtual CustomerDM Customer { get; set; }
        public virtual IList<OrderPaymentDM> OrderPayments { get; set; }
        public virtual ShipmentDM? Shipment { get; set; }
